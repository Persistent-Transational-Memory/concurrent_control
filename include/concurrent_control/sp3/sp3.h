...
#pragma once
#ifndef CC_SP_ATOMIC_H
#define CC_SP_ATOMIC_H
...
namespace cc::sp {
	...
	public: // Class Property
		...
		explicit SP(StorageManager *storage_manager_ptr):
			...
			util::logger_warn("Atomic version of SP can't make sure that data read is integral when running transaction, "
	...
	private: // Transaction Deal
		...
		bool remove(Context &tx_context, const AbKeyType &key) {
			util::logger_exception("Haven't implemented remove for sp3.");
			return false;
		}
