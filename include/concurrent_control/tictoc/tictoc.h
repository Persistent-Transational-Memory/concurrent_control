...
#pragma once
#ifndef CC_TICTOC_ATOMIC_H
#define CC_TICTOC_ATOMIC_H
	...
	namespace tictoc {
		...
		public: // Class Property
			...
			explicit TicToc(StorageManager *storage_manager_ptr_ptr):
				...
				logger.warn("Atomic version of TICTOC can't make sure that data read is integral when running transaction, "
